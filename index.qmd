...
0.25X_{1} + 0.35X_{2} + 0.3X_{3} + 0.1X_{4} &\leq 1000  ~\text{(Aislamiento)} \\
0.45X_{1} + 0.5X_{2} + 0.4X_{3} + 0.22X_{4} &\leq 1000  ~\text{(Costura)} \\
0.15X_{1} + 0.15X_{2} + 0.1X_{3} + 0.05X_{4} &\leq 1000 ~\text{(Empaque)} \\
